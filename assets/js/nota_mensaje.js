...
$(function () {
    const puno = localStorage.getItem("super02Puno");
    const pdos = localStorage.getItem("super02Pdos");
    const ptres = localStorage.getItem("super02Ptres");
    const pcuatro = localStorage.getItem("super02Pcuatro");
    const pcinco = localStorage.getItem("super02Pcinco");
    const pseis = localStorage.getItem("super02Pseis");
    const psiete = localStorage.getItem("super02Psiete");
    const pocho = localStorage.getItem("super02Pocho");
    const pnueve = localStorage.getItem("super02Pnueve");
    const pdiez = localStorage.getItem("super02Pdiez");
    const ponce = localStorage.getItem("super02Ponce");
    const pdoce = localStorage.getItem("super02Pdoce");
    const ptrece = localStorage.getItem("super02Ptrece");
    const pcatorce = localStorage.getItem("super02Pcatorce");
    const pquince = localStorage.getItem("super02Pquince");
    const pdieciseis = localStorage.getItem("super02Pdieciseis");
    const pdiecisiete = localStorage.getItem("super02Pdiecisiete");
    const pdieciocho = localStorage.getItem("super02Pdieciocho");
    const pdiecinueve = localStorage.getItem("super02Pdiecinueve");
    const pveinte = localStorage.getItem("super02Pveinte");
    const pveintiuno = localStorage.getItem("super02Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.super02Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.super02Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.super02Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.super02Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.super02Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.super02Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.super02Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.super02Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.super02Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.super02Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.super02Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.super02Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.super02Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.super02Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.super02Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.super02Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.super02Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.super02Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.super02Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.super02Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.super02Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.super02Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.super02Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.super02Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.super02Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.super02Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.super02Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.super02Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.super02Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.super02Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.super02Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.super02Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.super02Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.super02Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.super02Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.super02Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.super02Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.super02Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.super02Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.super02Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.super02Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.super02Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.super02Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.super02Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.super02Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.super02Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.super02Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.super02Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.super02Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.super02Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.super02Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.super02Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.super02Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.super02Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.super02Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.super02Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.super02Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.super02Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.super02Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.super02Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.super02Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.super02Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.super02Pveintiuno);
