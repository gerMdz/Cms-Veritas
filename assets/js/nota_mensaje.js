...
$(function () {
    const puno = localStorage.getItem("super03Puno");
    const pdos = localStorage.getItem("super03Pdos");
    const ptres = localStorage.getItem("super03Ptres");
    const pcuatro = localStorage.getItem("super03Pcuatro");
    const pcinco = localStorage.getItem("super03Pcinco");
    const pseis = localStorage.getItem("super03Pseis");
    const psiete = localStorage.getItem("super03Psiete");
    const pocho = localStorage.getItem("super03Pocho");
    const pnueve = localStorage.getItem("super03Pnueve");
    const pdiez = localStorage.getItem("super03Pdiez");
    const ponce = localStorage.getItem("super03Ponce");
    const pdoce = localStorage.getItem("super03Pdoce");
    const ptrece = localStorage.getItem("super03Ptrece");
    const pcatorce = localStorage.getItem("super03Pcatorce");
    const pquince = localStorage.getItem("super03Pquince");
    const pdieciseis = localStorage.getItem("super03Pdieciseis");
    const pdiecisiete = localStorage.getItem("super03Pdiecisiete");
    const pdieciocho = localStorage.getItem("super03Pdieciocho");
    const pdiecinueve = localStorage.getItem("super03Pdiecinueve");
    const pveinte = localStorage.getItem("super03Pveinte");
    const pveintiuno = localStorage.getItem("super03Pveintiuno");

    if (pcinco != null) {
        $('#pcinco').val(JSON.parse(localStorage.super03Pcinco));
    ...
    if (puno != null) {
        $('#puno').val(JSON.parse(localStorage.super03Puno));
    ...
    if (pdos != null) {
        $('#pdos').val(JSON.parse(localStorage.super03Pdos));
    ...
    if (ptres != null) {
        $('#ptres').val(JSON.parse(localStorage.super03Ptres));
    ...
    if (pcuatro != null) {
        $('#pcuatro').val(JSON.parse(localStorage.super03Pcuatro));
    ...
    if (pseis != null) {
        $('#pseis').val(JSON.parse(localStorage.super03Pseis));
    ...
    if (psiete != null) {
        $('#psiete').val(JSON.parse(localStorage.super03Psiete));
    ...
    if (pocho != null) {
        $('#pocho').val(JSON.parse(localStorage.super03Pocho));
    ...
    if (pnueve != null) {
        $('#pnueve').val(JSON.parse(localStorage.super03Pnueve));
    ...
    if (pdiez != null) {
        $('#pdiez').val(JSON.parse(localStorage.super03Pdiez));
    ...
    if (ponce != null) {
        $('#ponce').val(JSON.parse(localStorage.super03Ponce));
    ...
    if (pdoce != null) {
        $('#pdoce').val(JSON.parse(localStorage.super03Pdoce));
    ...
    if (ptrece != null) {
        $('#ptrece').val(JSON.parse(localStorage.super03Ptrece));
    ...
    if (pcatorce != null) {
        $('#pcatorce').val(JSON.parse(localStorage.super03Pcatorce));
    ...
    if (pquince != null) {
        $('#pquince').val(JSON.parse(localStorage.super03Pquince));
    ...
    if (pdieciseis != null) {
        $('#pdieciseis').val(JSON.parse(localStorage.super03Pdieciseis));
    ...
    if (pdiecisiete != null) {
        $('#pdiecisiete').val(JSON.parse(localStorage.super03Pdiecisiete));
    ...
    if (pdieciocho != null) {
        $('#pdieciocho').val(JSON.parse(localStorage.super03Pdieciocho));
    ...
    if (pdiecinueve != null) {
        $('#pdiecinueve').val(JSON.parse(localStorage.super03Pdiecinueve));
    ...
    if (pveinte != null) {
        $('#pveinte').val(JSON.parse(localStorage.super03Pveinte));
    ...
    if (pveintiuno != null) {
        $('#pveintiuno').val(JSON.parse(localStorage.super03Pveintiuno));
...
function procesa(p) {
    if (p === 'diez') {
        const pdiez = $('#pdiez').val();
        localStorage.super03Pdiez = JSON.stringify(pdiez);
    }

    if (p === 'nueve') {
        const pnueve = $('#pnueve').val();
        localStorage.super03Pnueve = JSON.stringify(pnueve);
    }

    if (p === 'ocho') {
        const pocho = $('#pocho').val();
        localStorage.super03Pocho = JSON.stringify(pocho);
    }

    if (p === 'siete') {
        const psiete = $('#psiete').val();
        localStorage.super03Psiete = JSON.stringify(psiete);
    }

    if (p === 'seis') {
        const pseis = $('#pseis').val();
        localStorage.super03Pseis = JSON.stringify(pseis);
    }

    if (p === 'cinco') {
        const pcinco = $('#pcinco').val();
        localStorage.super03Pcinco = JSON.stringify(pcinco);
    }

    if (p === 'uno') {
        const puno = $('#puno').val();
        localStorage.super03Puno = JSON.stringify(puno);
    }

    if (p === 'dos') {
        const pdos = $('#pdos').val();
        localStorage.super03Pdos = JSON.stringify(pdos);
    }

    if (p === 'tres') {
        const ptres = $('#ptres').val();
        localStorage.super03Ptres = JSON.stringify(ptres);
    }

    if (p === 'cuatro') {
        const pcuatro = $('#pcuatro').val();
        localStorage.super03Pcuatro = JSON.stringify(pcuatro);
    }

    if (p === 'once') {
        const ponce = $('#ponce').val();
        localStorage.super03Ponce = JSON.stringify(ponce);
    }

    if (p === 'doce') {
        const pdoce = $('#pdoce').val();
        localStorage.super03Pdoce = JSON.stringify(pdoce);
    }
    if (p === 'trece') {
        const ptrece = $('#ptrece').val();
        localStorage.super03Ptrece = JSON.stringify(ptrece);
    }
    if (p === 'catorce') {
        const pcatorce = $('#pcatorce').val();
        localStorage.super03Pcatorce = JSON.stringify(pcatorce);
    }
    if (p === 'quince') {
        const pquince = $('#pquince').val();
        localStorage.super03Pquince = JSON.stringify(pquince);
    }
    if (p === 'dieciseis') {
        const pdieciseis = $('#pdieciseis').val();
        localStorage.super03Pdieciseis = JSON.stringify(pdieciseis);
    }
    if (p === 'diecisiete') {
        const pdiecisiete = $('#pdiecisiete').val();
        localStorage.super03Pdiecisiete = JSON.stringify(pdiecisiete);
    }
    if (p === 'dieciocho') {
        const pdieciocho = $('#pdieciocho').val();
        localStorage.super03Pdieciocho = JSON.stringify(pdieciocho);
    }
    if (p === 'diecinueve') {
        const pdiecinueve = $('#pdiecinueve').val();
        localStorage.super03Pdiecinueve = JSON.stringify(pdiecinueve);
    }
    if (p === 'veinte') {
        const pveinte = $('#pveinte').val();
        localStorage.super03Pveinte = JSON.stringify(pveinte);
    }
    if (p === 'veintiuno') {
        const pveintiuno = $('#pveintiuno').val();
        localStorage.super03Pveintiuno = JSON.stringify(pveintiuno);
    }
...
function aceptado(p) {
    ...
    if (p === 'diez') {
        const pdiez = JSON.parse(localStorage.super03Pdiez);
    ...
    if (p === 'nueve') {
        const pnueve = JSON.parse(localStorage.super03Pnueve);
    ...
    if (p === 'ocho') {
        const pocho = JSON.parse(localStorage.super03Pocho);
    ...
    if (p === 'seis') {
        const pseis = JSON.parse(localStorage.super03Pseis);
    ...
    if (p === 'siete') {
        const psiete = JSON.parse(localStorage.super03Psiete);
    ...
    if (p === 'uno') {
        const puno = JSON.parse(localStorage.super03Puno);
    ...
    if (p === 'cinco') {
        const pcinco = JSON.parse(localStorage.super03Pcinco);
    ...
    if (p === 'dos') {
        const pdos = JSON.parse(localStorage.super03Pdos);
    ...
    if (p === 'tres') {
        const ptres = JSON.parse(localStorage.super03Ptres);
    ...
    if (p === 'cuatro') {
        const pcuatro = JSON.parse(localStorage.super03Pcuatro);
    ...
    if (p === 'once') {
        const ponce = JSON.parse(localStorage.super03Ponce);
    ...
    if (p === 'doce') {
        const pdoce = JSON.parse(localStorage.super03Pdoce);
    ...
    if (p === 'trece') {
        const ptrece = JSON.parse(localStorage.super03Ptrece);
    ...
    if (p === 'catorce') {
        const pcatorce = JSON.parse(localStorage.super03Pcatorce);
    ...
    if (p === 'quince') {
        const pquince = JSON.parse(localStorage.super03Pquince);
    ...
    if (p === 'dieciseis') {
        const pdieciseis = JSON.parse(localStorage.super03Pdieciseis);
    ...
    if (p === 'diecisiete') {
        const pdiecisiete = JSON.parse(localStorage.super03Pdiecisiete);
    ...
    if (p === 'dieciocho') {
        const pdieciocho = JSON.parse(localStorage.super03Pdieciocho);
    ...
    if (p === 'diecinueve') {
        const pdiecinueve = JSON.parse(localStorage.super03Pdiecinueve);
    ...
    if (p === 'veinte') {
        const pveinte = JSON.parse(localStorage.super03Pveinte);
    ...
    if (p === 'veintiuno') {
        const pveintiuno = JSON.parse(localStorage.super03Pveintiuno);
